...
export function HeroSection({ videoUrl }: Props) {
  return (
    <section className="relative z-0 flex min-h-[52svh] items-center overflow-hidden min-[480px]:min-h-[55svh] sm:min-h-[72svh] md:min-h-[80svh] lg:min-h-[85svh]">
      ...
      <div className="absolute inset-x-0 top-[63%] z-10 mx-auto flex w-full max-w-6xl -translate-y-1/2 justify-center px-5 text-center sm:relative sm:inset-auto sm:top-auto sm:translate-y-0 sm:items-stretch sm:justify-start sm:px-6 sm:pb-20 sm:pt-28 sm:text-left md:pb-18 md:pt-24">
