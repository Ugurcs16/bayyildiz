...
export function HomeCatalog({ products }: { products: CatalogProduct[] }) {
  ...
  return (
    <>
      <section
        id="urunler"
        className="scroll-mt-20 border-t border-black/[0.06] bg-[var(--color-cream)] px-4 py-10 sm:px-6 sm:py-12"
      >
      ...
      <section
        id="kategoriler"
        className="scroll-mt-20 border-t border-black/[0.06] bg-[var(--color-ivory)] px-4 py-10 sm:px-6 sm:py-12"
      >
        <div className="mx-auto max-w-6xl">
